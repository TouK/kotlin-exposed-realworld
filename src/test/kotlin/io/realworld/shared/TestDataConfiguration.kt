...
import io.realworld.article.infrastructure.TestTagRepository
...
@Import(value = [
    TestUserRepository::class, TestArticleRepository::class, TestTagRepository::class, TestCommentRepository::class
])
@Configuration
